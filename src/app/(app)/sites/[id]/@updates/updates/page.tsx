...
export default function UserSiteUpdatesPage() {
  return (
    <PageWrapper className="gap-8">
      ...
      <Alert severity="warning">
        ...
        <strong> Site updates features are not yet implemented.</strong>
      </Alert>
      ...
      <p>
        Sit deleniti iusto et galisum modi eos repellendus officiis et enim
