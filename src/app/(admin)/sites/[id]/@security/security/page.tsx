...
export default function UserSiteSecurityPage() {
  return (
    <PageWrapper className="gap-8">
      <PageHead title="Security" alignTitle="left" size="h5" />

      <Alert severity="warning">
        This page is work in progress.
        <strong> Site security features are not yet implemented.</strong>
      </Alert>
      ...
      <p>
        ...
        veniam modi vel amet modi!
      </p>

      <p>
        Aut consequuntur omnis id accusantium obcaecati cum velit saepe qui
        dolores cupiditate hic blanditiis similique. Sed dolor libero sit omnis
        veniam sed repellat omnis eos nisi temporibus est laudantium internos.
        Hic voluptatem cumque ad odio impedit et quisquam accusamus. Ut eveniet
      ...
      <p>
        ...
        temporibus est laudantium internos.
      </p>
